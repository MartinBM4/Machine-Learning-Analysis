...
midecisiontree = DecisionTreeClassifier()
...
migrid = {'max_depth':[1,3,5]}

migscv = GridSearchCV(estimator=midecisiontree,param_grid=migrid,scoring='accuracy',cv=10,verbose=2)
...
plot_tree(midtopt,rounded=True,filled=True)
