...
migrid = {'hidden_layer_sizes':[(20,30,20),(20,20,20),(10,30,20),(20,50,20),(20,70,20),(20,40,15)]}

migscv = GridSearchCV(estimator=miNN,param_grid=migrid,scoring='accuracy',cv=10,verbose=2)
